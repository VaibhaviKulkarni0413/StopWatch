...
class stopwatch(tk.Frame):
    def __init__(self,window=None):
        ...
        self.pack()
        self.features()
        total_hours_string = f'{self.total_hours}' if self.total_hours > 9 else f'self.total_hours'
    ...
    def features(self):
        ...
        self.stop_time_button = tk.Button(self,text="STOP",height=5,width=7,font=('arial',19,"bold"),background="purple",command=self.pause_time)
        ...
        self.window.title('MY OWN STOP WATCH')
